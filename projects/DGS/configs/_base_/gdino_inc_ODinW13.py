...
# -------------------------------------------------#
dataset_type = 'ODinW13_Dataset'
data_root = 'data/ODinW13/'
data_metric = 'CocoMetric'
ann_file_path = 'test/annotations_without_background.json'
...
caption_prompt = None
metainfo = ('AerialMaritimeDrone', 'Aquarium', 'CottontailRabbits', 'EgoHands', 'NorthAmericaMushroom',
